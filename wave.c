...
static unsigned int sample_end_percent_value(const size_t whole_process_len,
					const struct AttnTab * Tab,const size_t * offset,const size_t wrote_len){
...
static void WriteWave_Worker(float * Buffer,const struct WaveTab * wt,const struct WaveArgs * arg,const size_t len,size_t pending_len,size_t wrote_len){ //len refers to array element numbers.
